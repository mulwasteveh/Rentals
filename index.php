...
$curl_Tranfer2_post_data = [
    ...
    'AccountReference' => 'Stephen Mulwa',
...
//echo "<script>alert(Successfuly enter your mpesa pin to complete);</script>";
}
...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="#page-top">Bungoma County</a>
    ...
    <header class="masthead">
      <div class="container">
        <div class="intro-text">
          <div class="intro-lead-in">Bungoma Rentals Marketing Platform</div>
          <div class="intro-heading text-uppercase">Best Housing Platform<br></div>
        </div>
      </div>
    </header>
          ...
          <div class="col-md-12">
            ...
            <?php 
                foreach ($data as $key => $value) {           
                  echo ' <form style= action="index.php" method="POST"> <div class="card card-inverse card-info mb-3" style="padding:1%;">          
               ...
               <br><br>
               <button class="button" name="paynow" style="color: white; background-color: blue;">
               Make Payment Now
               </button>
    ...
    <footer style="background-color: #ccc;">
      <div class="container">
        <div class="row">
          <div class="col-md-4">
            <span class="copyright">Copyright &copy; Mulwa Stephen@2022</span>
          </div>
          <div class="col-md-4">
